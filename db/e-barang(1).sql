...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 12, 2023 at 01:36 PM
...
(49, 'DBM001', 'Sunlight', 9, 10, '2023-01-05', '2023-07-08', 90, 1);
...
INSERT INTO `request_barang` (`id_request_barang`, `kode_request_barang`, `nama_barang`, `kts_satuan`, `harga_paket`, `harga_total_request`, `tgl_barang_expired`, `tgl_request_barang`, `status_request`, `id_kategori_barang`, `id_barang_masuk`) VALUES
...
ALTER TABLE `barang_return`
  ...
  ADD KEY `id_barang_masuk` (`total_barang_return`);
...
--
ALTER TABLE `barang_keluar`
  MODIFY `id_barang_keluar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;

--
-- AUTO_INCREMENT for table `barang_masuk`
--
ALTER TABLE `barang_masuk`
  MODIFY `id_barang_masuk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;

--
-- AUTO_INCREMENT for table `barang_return`
--
ALTER TABLE `barang_return`
  MODIFY `id_barang_return` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `barang_rusak`
--
ALTER TABLE `barang_rusak`
  MODIFY `id_barang_rusak` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
...
--
ALTER TABLE `request_barang`
  MODIFY `id_request_barang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
